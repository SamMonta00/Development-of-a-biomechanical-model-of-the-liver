...
def createScene(root):
    ...
    root.addObject("MeshSTLLoader", name="LiverSurface", filename = r"C:\Users\monta\Desktop\Materie\Altro\Tirocinio\Liver_Database\3D_Slicer\liver_sofa\Liver_Target_1.stl")

    # Parenchima epatico modellato attraverso il metodo MJEDTetrahedralForceField
    liver = root.addChild('Liver')
    liver.addObject('EulerImplicitSolver', name="cg_odesolver", rayleighStiffness="0.1", rayleighMass="0.1")
    liver.addObject('CGLinearSolver', name="linear_solver", iterations="25", tolerance="1e-09", threshold="1e-09")
    liver.addObject("MeshGmshLoader", name="meshLoader", filename = r"C:\Users\monta\Desktop\Materie\Altro\Tirocinio\Liver_Database\3D_Slicer\liver_gmsh\Liver_Target_1.msh")  
    ...
    FEM = liver.addObject('MJEDTetrahedralForceField', template="Vec3d", name="TetraFEM", ParameterSet = '0.9 0.2 400', materialName = 'MooneyRivlin', viscous = True, ParameterAlpha = '0.235 0.333', ParameterTau = '0.27 0.03')

    # Capsula di Glisson modellata attraverso il metodo TriangularBendingSprings
    liverCapsule = liver.addChild('GlissonCapsule')
    liverCapsule.addObject('MeshSTLLoader', name='CapsuleMesh', filename = r"C:\Users\monta\Desktop\Materie\Altro\Tirocinio\Liver_Database\3D_Slicer\liver_sofa\Liver_Target_1.stl")
